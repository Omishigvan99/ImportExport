...
<body>
    ...
    <form action="RegisterController" method="post">
        <div class="card">
            ...
            <p class="text-center">Enter your credentials to create an account.</p>

            <%-- Display custom error message if registration fails --%>
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="portId" placeholder="Enter Port ID" name="port_id" required />
